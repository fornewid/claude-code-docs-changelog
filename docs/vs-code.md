...
| `focusView`                         | `false` | Hide tool calls, tool results, and thinking behind one expandable row per turn, leaving your prompts and Claude's responses. You can also toggle Focus view from the command menu. Requires Claude Code v2.1.221 or later                                                                                                                                                                                                                   |
